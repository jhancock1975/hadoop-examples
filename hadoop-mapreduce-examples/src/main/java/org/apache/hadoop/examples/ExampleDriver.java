...
public class ExampleDriver {
  ...
  public static void main(String argv[]){
    ...
    try {
    	System.out.println("*****************************************************************");
      pgd.addClass("ffwordcount", WordCount.class, 
      ...
      pgd.addClass("ObjWrite", ObjWrite.class, "count pairs of words on lines");
      pgd.addClass("sequencefilecreator", SequenceFileCreator.class, "create a sequence file.");
