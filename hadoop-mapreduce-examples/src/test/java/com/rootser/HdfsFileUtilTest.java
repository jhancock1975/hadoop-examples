...
public class HdfsFileUtilTest {
	...
	public static void setUp() throws IOException {
		InputStream inputStream = HdfsFileUtilTest.class.getClassLoader()
	 ...
	 * -even-if-it-is-compressed.htmll need separate logic for testing util, so
	 * we're not hiding bugs
	 * 
	 * @param location
	 * @param conf
	 * @return
